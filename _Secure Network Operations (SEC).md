...
conf t
 ...
 ip route 10.12.0.0 255.255.0.0 10.12.12.4 253
 no ip route 10.12.0.0 255.255.0.0 200.0.0.12 254
 end
~~~
...
conf t
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.12.100.4 254
 end
~~~
...
!@CoreBABA
conf t
 ip route 0.0.0.0 0.0.0.0 10.12.12.1 254
 end
~~~
...
~~~
!@cmd
ping 10.12.1.2                 CoreTAAS
ping 10.12.1.4                 CoreBABA
ping 10.12.100.8               CUCM
ping 10.12.12.1            EDGE
~~~
